...
!function () {
    ...
    $( "#scorecontainer" ).after( "<div id='mvprankcontainer' style='display:none;max-height: 310px;overflow:auto;'><ul id='mvprankplayerlist'></ul></div>" );
    ...
    function calcmvps () {
        ...
        $.each(sortedarr, function( index, value ) {
            $("#mvprankplayerlist").append("<li class='item'>" + index + ". <div class='name'><div class='" + value.pteam + "'> " + value.plyrname + "</div></div><div style='float:right;padding-right: 2em;'>" + value.pscore + "</div></li>");
        });
